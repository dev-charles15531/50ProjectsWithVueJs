<template>
    <div class="w-full bg-[#f5f6fa] mt-5">
        <div class="flex flex-col-reverse md:flex-row items-start space-x-0 md:space-x-10 p-3 md:p-5 text-xs md:text-[16px]">

            <!-- ========================================================== -->
            <!-- display flex with reply icon for small screens downwards   -->
            <div class="w-full md:w-auto pt-5 md:pt-0 flex justify-between items-center md:block">
                <div class="flex flex-row md:flex-col space-x-5 md:space-x-0 md:space-y-4 items-center bg-[#eaecf1] px-5 py-2 md:px-3 md:py-2 rounded-xl md:rounded-md">
                    <!-- upvote icon -->
                ...
                <div class="block md:hidden">
                    <div v-if="currentUser.username === comment.user.username" class="flex space-x-3 items-center text-xs md:text-sm font-medium">
                        <div class="flex space-x-1 items-center cursor-pointer text-[#ed6468] hover:text-[#ffb8bb]">
                            <div>
                        ...
                        <div>
                            <div v-if="!isEditBoxShowing" @click="isEditBoxShowing = true" class="flex space-x-1 items-center cursor-pointer text-[#5457b6] hover:text-[#c3c4ef]">
                                <div>
                                    <svg width="13" height="13" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.479 2.872 11.08.474a1.75 1.75 0 0 0-2.327-.06L.879 8.287a1.75 1.75 0 0 0-.5 1.06l-.375 3.648a.875.875 0 0 0 .875.954h.078l3.65-.333c.399-.04.773-.216 1.058-.499l7.875-7.875a1.68 1.68 0 0 0-.061-2.371Zm-2.975 2.923L8.159 3.449 9.865 1.7l2.389 2.39-1.75 1.706Z" fill="currentColor"/>
                                    </svg>
                                </div>
                                <div>Edit</div>
                            </div>
                            <div v-else  @click="isEditBoxShowing = false" class="flex items-center space-x-1 cursor-pointer text-[#5457b6] hover:text-[#c3c4ef]">
                    ...
                    <div v-else>
                        <div v-if="!isReplySectionShowing" class="flex items-center space-x-2 cursor-pointer text-[#5457b6] hover:text-[#c3c4ef]" @click="isReplySectionShowing = true">
                        ...
                        <div v-else class="flex items-center space-x-1 cursor-pointer text-[#5457b6] hover:text-[#c3c4ef]" @click="isReplySectionShowing = false">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd" />
                            </svg>
                            <h3 class="font-bold">
            ...
            <div class="w-full">
                <div class="flex justify-between items-center">
                    <div class="flex justify-start items-center space-x-2 md:space-x-4 text-gray-900">
                        <img :src="comment.user.image.png" alt="User Image" class="h-8 md:h-10 w-8 md:w-10">

                        <div>
                            <h4 class="font-medium">{{ comment.user.username }}</h4>
                        </div>
                        <!-- show if comment belongs to user -->
                        <div v-if="currentUser.username === comment.user.username" class="bg-[#5457b6] text-white text-xs md:text-sm px-2 py-1 md:py-0 md:pb-1 rounded-sm flex justify-center items-center">
                            <h4>you</h4>
                        </div>
                ...
                <div class="mt-4 text-[#67727e]">
                    ...
                    <div v-if="isEditBoxShowing" class="w-full">
                        ...
                        <div class="flex justify-end mt-3">
                            <input type="submit" value="update" class="uppercase cursor-pointer bg-[#5457b6] hover:bg-[#c3c4ef] text-white font-semibold px-4 pt-3 pb-3 rounded-md">
                        </div>
                    </div>
