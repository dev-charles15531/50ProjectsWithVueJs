  ...
  <div class="h-screen w-screen">
    <div class="w-full h-2/5 bg-blue-200 bg-[url('/imgs/pattern-bg.png')]">
      ...
      <div class="w-full py-5">
        <h2
          class="capitalize font-bold text-lg md:text-xl text-gray-100 text-center"
        >
          {{ title }}
        </h2>
      </div>
          ...
          <div class="inline-flex justify-center items-center w-full">
            <div class="w-9/12 md:w-1/4">
              <input
                ...
                class="w-full h-14 p-5 rounded-l-lg focus:outline-none text-[18px] focus:text-zinc-800 font-medium leading-none"
              />
            </div>
            <div
              @click="getIpAddressInfo()"
              class="w-14 h-14 rounded-r-lg flex justify-center items-center cursor-pointer bg-black hover:bg-zinc-800"
            >
      ...
      <div class="relative w-full bg-green-500 flex justify-center">
        <div
          class="absolute bg-white md:h-40 w-5/6 md:w-3/4 px-5 md:px-10 py-5 md:py-10 top-14 rounded-xl z-20"
        >
          <div
            class="w-full h-full space-y-2 md:space-y-0 md:flex md:justify-evenly md:items-center"
          >
            <!-- show ip address -->
            <div class="block h-full md:border-r-2 px-10">
              <h3 class="uppercase text-xs md:text-sm font-bold text-gray-500">
                ip address
              </h3>
